...
import { Options } from './interfaces/option.model';
import { Subscription } from 'rxjs/Subscription';

@Component({
  selector: 'app-mit-notifications',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './mit-notifications.component.html',
  styleUrls: ['./mit-notifications.component.scss'],
})
export class MitNotificationsComponent implements OnInit, OnDestroy {
  ...
  constructor(private _service: MitNotificationsService) { }
