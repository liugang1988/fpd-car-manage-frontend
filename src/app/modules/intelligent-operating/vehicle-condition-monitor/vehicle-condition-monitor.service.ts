...
@Injectable()
export class VehicleConditionMonitorService {
  ...
  // 监控列表导出
  GetPageCarMonitorVehiclesExcel(data){
    return this.authHttp.download(environment.baseUrl + 'CarConditionMonitor/GetPageCarMonitorVehiclesExcel', data);
  }
}
