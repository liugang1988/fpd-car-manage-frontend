...
export class SecurityAlertService {
  ...
  // 报警处理分页数据
  GetPageAlertRecordList( data ) {
    return this.authHttp.post( environment.baseUrl + 'SecurityAlarm/GetPageAlertRecordList', data );
  }
  ...
  // 安全报警导出
  GetPageAlertRecordListExcel(data){
    return this.authHttp.download( environment.baseUrl + 'SecurityAlarm/GetPageAlertRecordListExcel' , data );
  }
