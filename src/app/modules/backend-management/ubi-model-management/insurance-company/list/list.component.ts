...
export class ListComponent extends MitDataTableBase implements OnInit, OnDestroy {
  ...
  getList() {
    this.getRenderList = this.insuranceCompanyService.InsuranceCompanyList(this.query).subscribe((res) => {
      if ( res.State ) {
  ...
  updateStatus(id, status) {
    ...
    this.insuranceCompanyService.UpdateInsuranceCompanyStatus(data).subscribe((res) => {
