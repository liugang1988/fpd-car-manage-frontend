...
export class ModifyComponent implements OnInit {
  ...
  GetSingleOrganization(data) {
    // this.insuranceReportService.GetSingleOrganization(data).subscribe((res) => {
    //   if (res.State) {
  ...
  UpdateOrganization(form) {
    ...
    // this.insuranceReportService.UpdateOrganizationDept(form).subscribe((res) => {
    //   // 发起事件代理广播并返回上一页
  ...
  AddOrganization(form) {
    // this.showLoading = true;
    // this.insuranceReportService.AddOrganization(form).subscribe((res) => {
    //   // 发起事件代理广播并返回上一页
    //   this.eventsService.emitMessageEvent(res.State === 1 ? this.eventsService.eventNames.EVENT_TOAST_SUCCESS : this.eventsService.eventNames.EVENT_TOAST_ERROR, res.Message);
    //   this.back();
